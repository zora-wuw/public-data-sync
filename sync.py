...
if __name__ == "__main__":
	...
	dtype_spec = {
	    'orcid': 'string',
	    'path': 'string',
	    'date_created': 'string',  # Will be parsed as dates during import
	    'last_modified': 'string'  # Will be parsed as dates during import
	}
	...
	for chunk in pd.read_csv("last_modified.csv", dtype=dtype_spec, parse_dates=parse_dates, chunksize=chunk_size, encoding="UTF-8"):
